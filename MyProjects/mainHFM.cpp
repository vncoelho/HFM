...
#include "HFM/mainForecastingCodes/onlineHFM.cpp"
#include "HFM/mainForecastingCodes/usingNonDominatedModels.cpp"
#include "HFM/JSFunctions.hpp"
...
int main(int argc, char **argv)
{
	...
	optionSwitch = STOCK_MARKET;//STOCKMARKET
